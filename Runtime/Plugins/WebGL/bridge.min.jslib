...
function ACLoadCore() {
  ...
  var coreScriptSrc = "http://127.0.0.1:5501/dist/core-v2.min.js";
...
function ACInit(sdkVersion, checkoutPublicKey) {
  if (typeof window !== "undefined" && window.ACInit) {
    window.ACInit(SendMessage, sdkVersion, checkoutPublicKey);
  } else {
